    ...
    <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-left">
          ...
          <li><a id="pusher" href="#" title="New Dashboard" data-toggle="modal" data-target="#mdlDashboard"><span class="glyphicon glyphicon-plus-sign"></span></a></li>
        ...
        <ul class="nav navbar-nav navbar-right">
          <li><a href="dataviews.jsp">DataView Explorer</a></li>
          <li class="dropdown">
